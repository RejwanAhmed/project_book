				...
				<div class="row ">
					<div class="col-lg-2 col-sm-6">				
						<div class="form-group"> 					
							<label style = "font-size:20px;" ><b>Session:</b></label>
							<input class = "form-control" type="text" disabled placeholder = "No Project"  value = "<?php echo $row2['session']; ?>"/>							
						</div>
					</div>
					...
					<div class="col-lg-3 col-sm-6" >					
						...
						<div style = "text-align:center; margin-top:10px;" >							
							<input class="btn btn-success submit form-control" type="submit" name="showall" value="Show All " >				
						</div>
					</div>		
				</div>		
			</form>
