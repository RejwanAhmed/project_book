...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2019 at 05:36 PM
...
INSERT INTO `project_information` (`id`, `project_name`, `session`, `year`, `semester`, `supervisor`, `co_supervisor`, `member1`, `member2`, `member3`, `project_des`, `project_image`) VALUES
...
(30, 'Fishery Mangement System', '2012-2013', 'B.Sc. 4th', 'B.Sc. 8th Semester', 'A H M Kamal', '', 'Chamely Akter', 'Shahadat Alam', 'Jannatul Ferdous', 'Fishery Mangement System', ''),
